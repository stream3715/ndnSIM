...
main(int argc, char* argv[])
{
  ...
  */
  ...
  topologyReader.SetFileName("src/ndnSIM/examples/topologies/jre.txt");
...
*/
  ...
  // Producer
  Ptr<Node> producerMain = Names::Find<Node>(env_prdId);
  ...
  for (string id : vecConMajorId) {
    majorConsumerNodes.Add(Names::Find<Node>(id));
  }
  /*
  ...
  */
  ...
  majorConsumerHelper.SetAttribute("Frequency", StringValue("1")); // 100 interests a second
  ...
  for (string id : vecConMinorId) {
    minorConsumerNodes.Add(Names::Find<Node>(id));
  }
...
*/
  ...
  //major
  FibHelper::AddRoute(Names::Find<Node>("odawara"), ndn::Name(prefix + "/major"), Names::Find<Node>("chigasaki"), 0);
  FibHelper::AddRoute(Names::Find<Node>("chigasaki"), ndn::Name(prefix + "/major"), Names::Find<Node>("hashimoto"), 0);
